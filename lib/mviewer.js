...
mviewer = (function () {
    ...
    var _queryMap = function (evt, options) {
        ...
        if (queryType === 'map') {
            ...
            _map.forEachFeatureAtPixel(pixel, function (feature, layer) {
                ...
                if (l != 'featureoverlay' && _overLayers[l]) {
    ...
    return {
        ...
        zoomToLocation: function (x, y, zoom, lib) {
            // get layer to display marker point
            ...
            let ptResult = ol.proj.transform([x, y], 'EPSG:4326', _projection.getCode());
