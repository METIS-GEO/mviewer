...
mviewer = (function() {
    ...
    var _initTools = function() {
        ...
        // layer to display search result point - Metis specific code
    ...
    return {
            ...
            if (config.wmc) {
                ...
                $(themes.get().reverse()).each(function() {
                    ...
                    $(layersXml.get().reverse()).each(function() {
                        ...
                        oLayer.manage = $(this).attr("manage") == "false" ? false : true; // metis specific code
                        //styles
         ...
         * Modfied version - Metis Specific code to display geopin
         */
        ...
        // use to remove all feature from given layer - METIS specific code        
